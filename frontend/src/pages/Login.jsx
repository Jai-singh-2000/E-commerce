...
const Login = () => {
  ...
  const clearFormValues = () => { setFormValues({ email: '', password: '' }); setFormErrors({}); };
      ...
      >
        <Box sx={{ width: '100%', maxWidth: 420 }}>
          ...
          <Box
            component={Link}
            to="/"
            sx={{ display: 'inline-flex', alignItems: 'center', gap: 1, textDecoration: 'none', mb: 5 }}
          >
          ...
          <Typography sx={{ fontSize: '14px', color: '#8A9E86', mb: 5, fontFamily: "'Lato', sans-serif" }}>
          ...
          <Box mt={4} textAlign="center">
            <Typography sx={{ fontSize: '13px', color: '#9A9A9A', fontFamily: "'Lato', sans-serif" }}>
              ...
              <Link to="/signup" style={{ color: '#3CB815', fontWeight: 700, textDecoration: 'none' }}>
                Sign Up
              </Link>
            </Typography>
          </Box>
      ...
      >
        ...
        <Box sx={{ position: 'relative', width: 240, height: 240, mb: 6, zIndex: 2 }}>
          ...
          <Box sx={{
            ...
            <Typography sx={{ fontFamily: "'Cormorant Garamond', serif", fontSize: '13px', color: '#A5D6A7', fontWeight: 700, letterSpacing: '3px', textTransform: 'uppercase' }}>
              Planet
            </Typography>
          </Box>
          {/* Orbit dots */}
        ...
        <Typography sx={{ fontFamily: "'Cormorant Garamond', serif", fontSize: '42px', fontWeight: 700, color: '#fff', mb: 2, textAlign: 'center', zIndex: 2, lineHeight: 1.1 }}>
          Sustainable<br />
          <Box component="span" sx={{ color: '#A5D6A7', fontStyle: 'italic' }}>Living</Box>
        </Typography>

        <Typography sx={{ fontSize: '15px', color: 'rgba(255,255,255,0.55)', maxWidth: 340, textAlign: 'center', lineHeight: 1.8, zIndex: 2, fontFamily: "'Lato', sans-serif" }}>
          Access your account to manage orders, track shipments, and discover new eco-friendly arrivals.
        </Typography>

        {/* Stats */}
        <Box sx={{ display: 'flex', gap: 5, mt: 6, zIndex: 2 }}>
          {[{ num: '500+', label: 'Products' }, { num: '12K+', label: 'Customers' }].map((s) => (
            <Box key={s.label} textAlign="center">
              <Typography sx={{ fontFamily: "'Cormorant Garamond', serif", fontSize: '26px', fontWeight: 700, color: '#fff', lineHeight: 1 }}>{s.num}</Typography>
